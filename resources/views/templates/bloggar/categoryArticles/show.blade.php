...
@section('content')
    <div class="relative z-10 flex min-h-[400px] flex-col justify-center bg-cover bg-center bg-no-repeat before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:bg-[#232f4b] before:opacity-70 sm:min-h-[250px] md:mt-3">
        <div class="wraper">
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <div class="text-center">
                        <h1 class="mb-[20px] mt-[-10px] text-5xl text-white sm:mb-[10px] sm:text-3xl">
                            {!! $category->name !!}
                        </h1>
                        <ul class="">
