                ...
                <div class="wraper">
                    <div class="border-b-[1px] border-[#eeeeee] col:mb-2">
                        <div class="grid grid-cols-12 gap-x-3 items-center">
                            <div class="col-span-9 md:col-span-9 sm:col-span-12">
                                <ul>
                                    <li class="text-[16px] float-left sm:text-center col:float-none p-[15px_10px]
                                        md:p-[15px_5px] text-[#444444] pl-0">
                                        <span class=" p-[8px_6px] bg-[#616161] text-white text-sm">New Update</span>
                                    </li>
                                    <li class="text-[16px] md:text-[14px] float-left col:pt-0 col:float-none sm:float-none sm:text-center
                                        p-[15px_10px] md:p-[15px_5px] text-[#444444]">
                                        Betting against
                                        meme stocks could get you seriously burned</li>
                                </ul>
                            </div>
                            <div class="col-span-3 md:col-span-3 sm:col-span-12 ">
                                <ul class="float-right sm:float-none sm:text-center">
                                    <li class="inline-block"><a href="#"
                                            class="text-base p-[15px_10px] text-[#444] transition-all hover:text-[#3756f7]"><i
                                ...
                                <li>
                                    <a href="blog-left-sidebar.html" class="text-[16px]
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post With Left Sidebar</a>
                                </li>
                                <li>
                                    <a href="blog-fullwidth.html" class="text-[16px]
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post Fullwidth</a>
                                </li>
                                <li class="relative group/group-2">
                                    <a href="#" class="text-[16px]
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post details</a>
                                    <ul class="absolute w-[240px] left-[120%] top-0 pt-[20px] pb-[15px] px-[7px] z-[111] bg-[#fff]
                                        ...
                                        <li>
                                         ...
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post details right sidebar</a>
                                        </li>
                                        ...
                                        <li>
                                         ...
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post details left sidebar</a>
                                        </li>
                                        ...
                                        <li>
                                         ...
                                         lg:text-[16px] inline-block  px-[15px] capitalize py-1
                                            ...
                                            after:absolute after:left-[15px] after:bottom-0 after:w-0 after:h-[2px]
                                            after:content after:bg-[#3756f7] after:transition-all font-heading-font
                                            hover:after:w-[50%]">Post details fullwidth</a>
                                        </li>
        ...
        <section class="md:mt-4">
            <div class="wraper">
                <div class="sortable-gallery">
                    ...
                    <div class="m-[0_-7.5px] gallery-container clearfix">
                        <div class="flex w-[50%] float-left p-[0_7.5px_15px] col:p-0 col:mb-4 lg:block  lg:w-full">
                            <div class="relative rounded-[15px] overflow-hidden z-10 group before:absolute before:left-0 before:top-0 before:w-full
                                ...
                                <img src="assets/images/hero/img-1.jpg" alt
                                    class="img img-responsive w-full rounded-[15px] scale-[1] transition-all group-hover:scale-[1.3]">
                                <div class="absolute left-0 bottom-0 p-[30px] z-20 col:p-3">
                                    ...
                                    bg-[rgba(255,255,255,0.8)] col:text-base">Fasion</div>
                                    <h2 class="text-[35px] text-white mt-[15px] leading-10 col:text-xl font-semibold"><a
                                            href="blog-single.html">What’s In Trend In Women's Fashion
                                            Summer?</a></h2>
                                    <p class="text-white my-[15px] col:text-[14px] ">You can customize the view Blog
                                        posts with a simple mouse click and
                                    ...
                                    <ul class="flex items-center">
                                        ...
                                        <li
                                            class="relative text-white ml-[20px] pl-[20px] before:absolute before:left-[-8px] before:top-[25%] before:w-[8px] before:h-[8px] before:bg-white before:rounded-[50%] before:translate-y-1/2">
                                            20 Nov 2022</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="flex w-[50%] float-left p-[0_7.5px_15px] col:p-0 col:mb-4 lg:block lg:w-full">
                            <div class="relative rounded-[15px] overflow-hidden z-10 group before:absolute before:left-0 before:top-0 before:w-full
                                ...
                                <div class="absolute left-0 bottom-0 p-[30px] z-20 col:p-3">
                                    <div class="p-[3px_15px] text-center text-xl rounded-[5px] inline-block font-bold text-[#003aae] 
                                    bg-[rgba(255,255,255,0.8)] col:text-base">Travel</div>
                                    <h2
                                        class="text-[35px] text-white mt-[15px] leading-10 col:text-xl font-semibold col:mt-[10px]">
                                        <a href="blog-single.html">Traveling Makes You More Interesting</a></h2>
                                    <ul class="flex items-center">
                                        <li class="relative text-white ">By <a href="blog-single.html">Robert</a></li>
                                        <li
                                            class="relative text-white ml-[20px] pl-[20px] before:absolute before:left-[-8px] before:top-[25%] before:w-[8px] before:h-[8px] before:bg-white before:rounded-[50%] before:translate-y-1/2">
                        ...
                        <div
                            class="flex w-[50%] p-[0_7.5px_15px] col:p-0 justify-between lg:w-full m-[0_-5px] pr-0 sm:m-0 sm:pr-[7.5px] sm:block">
                            <div class="relative mx-[7px] sm:mx-0 sm:mb-4 rounded-[15px] overflow-hidden z-10 group before:absolute before:left-0 before:top-0 before:w-full
                                before:h-full before:bg-[rgba(7,7,7,0.4)] before:rounded-[15px] before:z-20">
                                <img src="assets/images/hero/img-3.jpg" alt
                                    class="img img-responsive w-full rounded-[15px] scale-[1] transition-all group-hover:scale-[1.3]">
                                <div class="absolute left-0 bottom-0 p-[30px] xl:p-[25px] z-20 col:p-2">
                                    <div class="p-[3px_15px] text-center text-xl rounded-[5px] inline-block font-bold text-[#003aae] 
                                    bg-[rgba(255,255,255,0.8)] col:text-base">Food</div>
                                    <h2 class="text-[28px] text-white mt-[15px]  font-semibold col:text-xl"><a
                                            href="blog-single.html">Top 10 Healthy Food</a></h2>
                                    <ul class="flex items-center">
                                        <li class="relative text-white ">By <a href="blog-single.html">Robert</a></li>
                                        <li
                                            class="relative text-white ml-[20px] pl-[20px] before:absolute before:left-[-8px] before:top-[25%] before:w-[8px] before:h-[8px] before:bg-white before:rounded-[50%] before:translate-y-1/2">
                            ...
                            <div class="relative mx-[7px] sm:mx-0 sm:mb-4 rounded-[15px] overflow-hidden z-10 group before:absolute before:left-0 before:top-0 before:w-full
                                before:h-full before:bg-[rgba(7,7,7,0.4)] before:rounded-[15px] before:z-20">
                                <img src="assets/images/hero/img-4.jpg" alt
                                    class="img img-responsive w-full rounded-[15px] scale-[1] transition-all group-hover:scale-[1.3]">
                                <div class="absolute left-0 bottom-0 p-[30px] xl:p-[25px] z-20 col:p-2">
                                    <div class="p-[3px_15px] text-center text-xl rounded-[5px] inline-block font-bold text-[#003aae] 
                                    bg-[rgba(255,255,255,0.8)] col:text-base">Business</div>
                                    <h2 class="text-[28px] text-white mt-[15px]  font-semibold col:text-xl"><a
                                            href="blog-single.html">What Makes a Leader?</a></h2>
                                    <ul class="flex items-center">
                                        <li class="relative text-white ">By <a href="blog-single.html">Robert</a></li>
                                        <li
                                            class="relative text-white ml-[20px] pl-[20px] before:absolute before:left-[-8px] before:top-[25%] before:w-[8px] before:h-[8px] before:bg-white before:rounded-[50%] before:translate-y-1/2">
                ...
                <div class="wpo-breacking-wrap owl-carousel bg-[#f9faff] border-y-[#e9edff] border">
                    <div class="s1 flex items-center p-5 border-x-[#e9edff] m-[-1px]">
                        <div class="basis-[30%] rounded-[6px]">
                            <img src="assets/images/breaking-news/img-1.jpg" alt="" class="rounded-[6px]">
                        </div>
                        <div class="basis-[70%] pl-[15px]">
                            <span class="text-[#777777]">22 Sep 2022</span>
                            <h3 class="text-[18px] font-semibold mt-[5px] ">
                                <a href="blog-single.html" class="text-[#444444] transition-all hover:text-[#3756f7]">5
                                    unbelievable secret about choosing
                                    right fuirniture</a>
                            </h3>
                        </div>
                    </div>
                    <div class="flex items-center p-5 border-x-[#e9edff] m-[-1px]">
                        <div class="basis-[30%] rounded-[6px]">
                            <img src="assets/images/breaking-news/img-2.jpg" alt="" class="rounded-[6px]">
                        </div>
                        <div class="basis-[70%] pl-[15px]">
                            <span class="text-[#777777]">22 Sep 2022</span>
                            <h3 class="text-[18px] font-semibold mt-[5px] ">
                                <a href="blog-single.html"
                                    class="text-[#444444] transition-all hover:text-[#3756f7]">Healthy rutine for your
                                    healthy
                                    lifestyle.</a>
                            </h3>
                        </div>
                    ...
                    <div class="flex items-center p-5 border-x-[#e9edff] m-[-1px]">
                        <div class="basis-[30%] rounded-[6px]">
                            <img src="assets/images/breaking-news/img-3.jpg" alt="" class="rounded-[6px]">
                        </div>
                        <div class="basis-[70%] pl-[15px]">
                            <span class="text-[#777777]">22 Sep 2022</span>
                            <h3 class="text-[18px] font-semibold mt-[5px] ">
                                <a href="blog-single.html"
                                    class="text-[#444444] transition-all hover:text-[#3756f7]">Best tourism site all
                                    over the
                                    world.</a>
                            </h3>
                        </div>
            ...
            <div class="wraper">
                <div class="mb-8 col:mb-6">
                    <h2 class="text-3xl font-bold text-[#444444] relative capitalize pb-5 col:text-2xl
                                    ...
                                    after:bg-[#3756f7] ">Today's Top Highlights</h2>
                </div>
                    ...
                    <div class="col-span-8 md:col-span-12">
                        ...
                        <div class="relative z-10 border border-[#eeeeee] p-7  col:p-4">
                            <div class="grid grid-cols-12 gap-x-4">
                                    ...
                                    <div class="mb-7 pb-5 border-b border-[#eeeeee] group">
                                        ...
                                        <div class="pt-3">
                                            <h2
                                                ...
                                                <a href="blog-single.html"
                                                    class="text-[#444] transition-all hover:text-[#3756f7]">Traveling
                                                    Makes You More Inteligent
                                                    and More Energetic</a>
                                            </h2>
                                        ...
                                        before:-translate-y-1/2 before:w-[6px] before:h-[6px] before:bg-[#3756f7] before:rounded-[50%]">
                                            ...
                                            <p class="text-[#444444] text-base">You can customize the view Blog post
                                                with author simple mouse click
                                    ...
                                    <div class="mb-7 pb-5 border-b border-[#eeeeee] group">
                                        ...
                                        <div class="pt-3">
                                            <h2
                                                class="text-xl font-heading-font mb-8 font-bold mt-3 xl:text-lg xl:mb-2 ">
                                                <a href="blog-single.html"
                                                    class="text-[#444] transition-all hover:text-[#3756f7]">12 Things to
                                                    See and Find Out in Bergen,
                                                    Norway</a>
                                            </h2>
                                            <ul class="flex mb-[15px] items-center">
                                                <li class="text-base text-[#3756f7]">
                                    ...
                                    <div class="mb-7 pb-5 border-b border-[#eeeeee] group">
                                        ...
                                        <div class="pt-3">
                                            <h2
                                                class="text-xl font-heading-font mb-8 font-bold mt-3 xl:text-lg xl:mb-2 ">
                                                <a href="blog-single.html"
                                                    class="text-[#444] transition-all hover:text-[#3756f7]">Healthy
                                                    Daily Rutine For Your Healthy
                                                    Lifestyle</a>
                                            </h2>
                                            <ul class="flex mb-[15px] items-center">
                                                <li class="text-base text-[#3756f7]">
                                    ...
                                    <div class="mb-7 pb-5 border-b border-[#eeeeee] group">
                                        ...
                                        <div class="pt-3">
                                            <h2
                                                class="text-xl font-heading-font mb-8 font-bold mt-3 xl:text-lg xl:mb-2 ">
                                                <a href="blog-single.html"
                                                    class="text-[#444] transition-all hover:text-[#3756f7]">Perfect
                                                    Photo Clicking Idea You Must
                                                    Khow About.</a>
                                            </h2>
                                            <ul class="flex mb-[15px] items-center">
                                                <li class="text-base text-[#3756f7]">
                                ...
                                <div class="col-span-6 md:col-span-6 sm:col-span-12">
                                    <div class="sm:mb-7 sm:pb-5 sm:border-b sm:border-[#eeeeee] group">
                                        <div class="overflow-hidden relative rounded-[6px]">
                            ...
                            <div class="mb-7 p-7 border-[#eef0fc] border">
                                ...
                                <ul>
                                    <li class="text-lg font-normal relative">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Lifestyle<span
                                                class="absolute right-0">(05)</span></a>
                                    </li>
                                    <li
                                        class="text-lg font-normal relative sm:text-base mt-5 pt-5 border-t border-[#eef0fc]">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Inspiration
                                            <span class="absolute right-0">(07)</span></a>
                                    </li>
                                    <li
                                        class="text-lg font-normal relative sm:text-base mt-5 pt-5 border-t border-[#eef0fc]">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Fashion
                                            <span class="absolute right-0">(03)</span></a>
                                    </li>
                                    <li
                                        class="text-lg font-normal relative sm:text-base mt-5 pt-5 border-t border-[#eef0fc]">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Photography
                                            <span class="absolute right-0">(06)</span></a>
                                    </li>
                                    <li
                                        class="text-lg font-normal relative sm:text-base mt-5 pt-5 border-t border-[#eef0fc]">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Travel
                                            <span class="absolute right-0">(12)</span></a>
                                    </li>
                                    <li
                                        class="text-lg font-normal relative sm:text-base mt-5 pt-5 border-t border-[#eef0fc]">
                                        <a href="blog-single.html"
                                            class="block text-[#474f62] relative pl-7 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:content-['\e649'] before:font-['themify'] before:text-base transition-all hover:text-[#3756f7] hover:before:text-[#3756f7] before:transition-all">Business
                                            <span class="absolute right-0">(08)</span></a>
                                    </li>
                                ...
                                <div class="posts">
                                    <div class="overflow-hidden">
                                        <div class="w-[70px] float-left">
                                            <img src="assets/images/recent-posts/img-1.jpg" alt class="rounded-[5px]">
                                        </div>
                                        <div class="w-[calc(100%-70px)] float-left pl-5">
                                            <span class="text-sm text-[#444444] relative top-[-5px]">19 Jun 2022 </span>
                                            <h4 class="text-lg font-medium"><a
                                                    class="text-[#232f4b] transition-all hover:text-[#3756f7]"
                                                    href="blog-single.html">Perfect Photo Clicking Idea You Must
                                                    Know.</a></h4>
                                        </div>
                                    </div>
                                    <div class="overflow-hidden mt-4 pt-4">
                                        <div class="w-[70px] float-left">
                                            <img src="assets/images/recent-posts/img-2.jpg" alt class="rounded-[5px]">
                                        </div>
                                        <div class="w-[calc(100%-70px)] float-left pl-5">
                                            <span class="text-sm text-[#444444] relative top-[-5px]">22 May 2022 </span>
                                            <h4 class="text-lg font-medium"><a
                                                    class="text-[#232f4b] transition-all hover:text-[#3756f7]"
                                                    href="blog-single.html">Best tourism site all over the world.</a>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="overflow-hidden mt-4 pt-4">
                                        <div class="w-[70px] float-left">
                                            <img src="assets/images/recent-posts/img-3.jpg" alt class="rounded-[5px]">
                                        </div>
                                        <div class="w-[calc(100%-70px)] float-left pl-5">
                                            <span class="text-sm text-[#444444] relative top-[-5px]">12 Apr 2022 </span>
                                            <h4 class="text-lg font-medium"><a
                                                    class="text-[#232f4b] transition-all hover:text-[#3756f7]"
                                                    href="blog-single.html">Whats In Trend in Now Woman Fashion.</a>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="overflow-hidden mt-4 pt-4">
                                        <div class="w-[70px] float-left">
                                            <img src="assets/images/recent-posts/img-4.jpg" alt class="rounded-[5px]">
                                        </div>
                                        <div class="w-[calc(100%-70px)] float-left pl-5">
                                            <span class="text-sm text-[#444444] relative top-[-5px]">12 Apr 2022 </span>
                                            <h4 class="text-lg font-medium"><a
                                                    class="text-[#232f4b] transition-all hover:text-[#3756f7]"
                                                    href="blog-single.html">Top 10 Healthy Food of Your Menu.</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="wraper">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6 col:col-span-12 md:mb-[30px]">
                            ...
                            <p class="mb-[10px] text-white text-[16px] leading-[30px]">There are many variations of
                            ...
                            <div class="pl-[50px] lg:pl-0 md:pl-0">
                                ...
                                <ul>
                                    <li class="relative z-[1] py-[6px] pl-[15px] before:absolute before:left-0
                                        ...
                                        <a href="blog.html" class="text-[16px] transition-all text-white 
                                ...
                                <ul>
                                    <li class="mb-[15px] ">
                                        ...
                                        <span class="flex items-center text-[14px] text-white">
                                            <i class="fi flaticon-calendar mr-[5px] text-[#3756f7] -mt-[2px]"></i>
                                            10.02.2024
                                        </span>
                                    </li>
                                    <li class="mb-[15px] ">
